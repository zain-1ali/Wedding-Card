  ...
  return (
    <>
      <Slider
        ...
        style={{
          backgroundColor: cardData?.accomodationBackground
            ? cardData?.bgColor
            : "white",
        }}
      >
        {cardData?.accomodation?.map((step, index) => (
          <div className="w-[100%]  sm:h-[100%]  h-[50%]  flex flex-col items-center mt-2">
            <h2
